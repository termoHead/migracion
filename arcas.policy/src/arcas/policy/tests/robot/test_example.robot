...
#
#  $ bin/test -s arcas.policy -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src arcas.policy.testing.ARCAS_POLICY_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/arcas/policy/tests/robot/test_example.robot
#
