...
#
#  $ bin/test -s arcas.content -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src arcas.content.testing.ARCAS_CONTENT_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/arcas/content/tests/robot/test_example.robot
#
